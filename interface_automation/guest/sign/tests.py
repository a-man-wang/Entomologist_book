...
class ModelTest(TestCase):
    def setUp(self) -> None:
        Event.objects.create(id=1, name='oneplus 3 event', limit=2000, status=True, address='shenzhen',
                             start_time=datetime(2019, 9, 22, 14, 0, 0))
...
class EventManageTest(TestCase):
    ...
    def setUp(self) -> None:
        User.objects.create_user('admin', 'admin@mail.com', 'admin123456')
        Event.objects.create(name='xiaomi5', limit=2000, status=1, address='beijing',
                             start_time=datetime(2019, 9, 22, 14, 0, 0))
...
class GuestManageTest(TestCase):
    ...
    def setUp(self) -> None:
        User.objects.create_user('admin', 'admin@mail.com', 'admin123456')
        Event.objects.create(id=1, name='xiaomi5', limit=2000, status=1, address='beijing',
                             start_time=datetime(2019, 9, 22, 14, 0, 0))
...
class SignIndexActionTest(TestCase):
    ...
    def setUp(self) -> None:
        ...
        Event.objects.create(id=1, name='xiaomi5', limit=2000, status=1, address='beijing',
                             start_time=datetime(2019, 9, 22, 14, 0, 0))
        Guest.objects.create(realname='alen', phone='18611001100', email="alen@mail.com", sign=0, event_id=1)
        Event.objects.create(id=2, name='oneplus4', limit=2000, status=1, address='shenzhen',
                             start_time=datetime(2019, 9, 22, 14, 0, 0))
